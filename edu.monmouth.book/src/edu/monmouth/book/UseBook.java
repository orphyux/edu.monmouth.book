...
public class UseBook {
	...
	public static void main(String[] args) {
		...
		try {
		 b1 = new Book(90, BookTypes.HARDCOVER,"Lord of the Flies", 8.99);
		...
		try {
			 b2 = new Book(287, BookTypes.SOFTCOVER, null, 15.40);
			 System.out.println(b2);
			} catch(BookException e1) {
			 System.err.println(e1.getMessage());
			}
		try {
			 b3 = new Book(0, BookTypes.ELECTRONIC, "Gone With The Wind", 9.99);
				System.out.println(b3);
			} catch(BookException e2) {
			 System.err.println(e2.getMessage());
			}
		try {
			 b4 = new Book(100, BookTypes.SOFTCOVER, "Hounds of Baskerville", 19.99);
		...
		try {
			 b5 = new Book(200, BookTypes.HARDCOVER, "Vampire Hunter", 29.99);
